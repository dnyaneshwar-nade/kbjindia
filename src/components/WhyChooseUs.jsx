...
const FeatureItem = ({ icon, title, description }) => {
  return (
    ...
    <motion.div
      className="flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-lg hover:shadow-2xl transition duration-300 ease-in-out"
      whileHover={{ scale: 1.05 }}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5 }}
    >
      <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 p-4 rounded-full mb-4">
